...
namespace Technodelight\SymfonyConfigurationInitialiser;
...
class Initialiser
{
    ...
    /**
     * @param BaseNode|PrototypeNodeInterface $node
     * @param BaseNode|PrototypeNodeInterface $parent
     * @param InputInterface $input
     * @param OutputInterface $output
     * @param $level
     */
    private function readValue($node, $parent, InputInterface $input, OutputInterface $output, $level)
    {
